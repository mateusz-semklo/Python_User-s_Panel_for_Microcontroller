# -*- coding: utf-8 -*-
"""
Created on Fri Sep 11 18:44:14 2020
...
def myClick5():
    global id_loop,flag,speed,encoder,t,ts,xs,ys,j,sock
    message = '{"settings":"n"}'
    #js=json.loads(jstring)
    #js["settings"]='n'
...
def plotGraph():
    ...
    chart.draw()
    chart.get_tk_widget().grid(row=i,column=0,columnspan=25,sticky=W)
...
button7 = Button(window, text = "bbb",height=2,width=10 ,command=myClick5)
button7.grid(row=i,column=6,rowspan=2,columnspan=4)
